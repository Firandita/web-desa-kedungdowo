 ...
 * ------------------------------------------------------------------
 * Dipakai HANYA sebagai fallback kalau tabel `beritas` masih kosong.
 * Begitu ada data asli di database (lewat admin panel), ini otomatis
 * tidak dipakai lagi (lihat logika di BeritaController).
 *
 * Setiap item berupa OBJECT (bukan array asosiatif) supaya cara
 * aksesnya ($berita->judul) SAMA PERSIS dengan cara akses model
 * Eloquent \App\Models\Berita, sehingga berita.blade.php dan
 * berita-detail.blade.php tidak perlu tahu apakah datanya dari
 * database atau dummy.
 */
