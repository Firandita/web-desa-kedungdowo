        ...
        <div class="space-y-6">
            ...
            <div class="grid md:grid-cols-4 gap-6 relative">
                ...
                <div class="bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm space-y-3 relative">
                    ...
                    <h3 class="font-bold text-gray-800 text-lg">Siapkan Berkas</h3>
                ...
                <div class="bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm space-y-3 relative">
                    ...
                    <h3 class="font-bold text-gray-800 text-lg">Persetujuan RT/RW</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">
                ...
                <div class="bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm space-y-3 relative">
                    ...
                    <h3 class="font-bold text-gray-800 text-lg">Datang ke Balai Desa</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">
                ...
                <div class="bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm space-y-3 relative">
                    ...
                    <h3 class="font-bold text-gray-800 text-lg">Verifikasi & Selesai</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">
        ...
        <div class="grid lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm space-y-4">
                <h3 class="font-display font-bold text-xl text-[var(--sawah-dark)] flex items-center gap-2">
                    <span class="material-icons-outlined text-[var(--panen)]">work</span> Berkas Persyaratan Utama
                </h3>
                <p class="text-sm text-gray-500">Warga wajib membawa dokumen asli beserta fotokopi (1 rangkap) saat mengajukan permohonan ke Balai Desa:</p>
                
                <ul class="space-y-3 pt-2">
                    <li class="flex items-start gap-3 text-sm text-gray-700">
                        <span class="material-icons-outlined text-emerald-600 shrink-0">check_circle</span>
                        <div>
            ...
            <div class="lg:col-span-5 bg-white p-6 rounded-2xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between">
                <div>
                    <h3 class="font-display font-bold text-xl text-[var(--sawah-dark)] mb-3 flex items-center gap-2">
                        <span class="material-icons-outlined text-[var(--sawah-dark)]">schedule</span> Jam Pelayanan Balai Desa
                    </h3>
                    <p class="text-sm text-gray-600 mb-4">Pastikan Anda datang pada waktu operasional berikut demi kelancaran proses verifikasi:</p>
                    
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between border-b pb-1.5 text-gray-700">
                ...
                <div class="bg-[var(--sawah)]/5 p-3 rounded-xl border border-[var(--sawah)]/10 text-xs text-gray-500 mt-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Keterangan Tidak Mampu (SKTM)</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="openModal('SKTM', 'Digunakan untuk pengajuan beasiswa, jaminan kesehatan nasional (KIS/PBI), keringanan biaya sekolah, atau bantuan sosial dari pemerintah.', '#')" class="flex items-center justify-center gap-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                        ...
                        <a href="#" class="flex items-center justify-center gap-1 bg-[var(--sawah-dark)] text-white hover:bg-[var(--sawah)] font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">download</span> Unduh
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Keterangan Usaha (SKU)</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="openModal('SKU', 'Digunakan sebagai bukti legalitas kepemilikan usaha mikro/kecil untuk keperluan syarat pengajuan modal atau KUR di Bank.', '#')" class="flex items-center justify-center gap-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">visibility</span> Detail
                        </button>
                        <a href="#" class="flex items-center justify-center gap-1 bg-[var(--sawah-dark)] text-white hover:bg-[var(--sawah)] font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">download</span> Unduh
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Keterangan Domisili Warga</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="openModal('Surat Keterangan Domisili', 'Surat resmi pembuktian keberadaan tempat tinggal bagi warga pendatang baru ataupun warga asli untuk keperluan pembukaan rekening bank atau lamaran kerja.', '#')" class="flex items-center justify-center gap-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">visibility</span> Detail
                        </button>
                        <a href="#" class="flex items-center justify-center gap-1 bg-[var(--sawah-dark)] text-white hover:bg-[var(--sawah)] font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">download</span> Unduh
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Pengantar Pengurusan KTP/KK</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="openModal('Surat Pengantar KTP/KK', 'Surat pengantar wajib dari desa guna melakukan penerbitan KK baru, pembaruan data KK, atau pembuatan KTP-el baru di Kantor Kecamatan.', '#')" class="flex items-center justify-center gap-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">visibility</span> Detail
                        </button>
                        <a href="#" class="flex items-center justify-center gap-1 bg-[var(--sawah-dark)] text-white hover:bg-[var(--sawah)] font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">download</span> Unduh
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Keterangan Kelahiran / Kematian</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                ...
                <div class="bg-white p-5 rounded-xl border border-[var(--sawah)]/10 shadow-sm flex flex-col justify-between gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-icons-outlined text-3xl text-blue-600 p-2 bg-blue-50 rounded-lg">description</span>
                        <div>
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">Surat Pengantar Izin Keramaian / Acara</h4>
                            <p class="text-xs text-gray-400 mt-1">Format: Word (.doc)</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="openModal('Surat Izin Keramaian', 'Diperlukan bagi warga yang ingin mengadakan hajatan besar, hiburan panggung, atau event publik demi keamanan bersama koordinasi dengan Babinkamtibmas.', '#')" class="flex items-center justify-center gap-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">visibility</span> Detail
                        </button>
                        <a href="#" class="flex items-center justify-center gap-1 bg-[var(--sawah-dark)] text-white hover:bg-[var(--sawah)] font-medium text-xs py-2.5 rounded-lg transition-all duration-200">
                            <span class="material-icons-outlined text-sm">download</span> Unduh
...
<div id="suratModal" class="fixed inset-0 z-50 hidden bg-black/50 flex items-center justify-center p-4 backdrop-blur-xs transition-all duration-300">
    <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl space-y-4 relative border border-gray-100 transform scale-95 transition-transform duration-300" id="modalCard">
        ...
        <!-- Deskripsi Konten -->
        <div class="space-y-2">
            <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wider">Kegunaan & Deskripsi:</h4>
            <p class="text-sm text-gray-600 leading-relaxed" id="modalDescription">
                Deskripsi perihal fungsi berkas surat terkait akan terisi otomatis di sini.
            </p>
        </div>

        <!-- Alert Notice -->
        <div class="bg-[var(--krem)] p-3 rounded-xl border border-[var(--sawah)]/10 text-xs text-gray-500 flex items-start gap-2">
            <span class="material-icons-outlined text-sm text-[var(--panen)] shrink-0">workspace_premium</span>
            <span>Pastikan data diisi sebenar-benarnya sebelum diserahkan ke perangkat lingkungan RT/RW.</span>
        </div>

        <!-- Action Buttons -->
        <div class="flex gap-3 pt-2">
            <button onclick="closeModal()" class="w-1/3 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-xs rounded-lg transition-all">
                Kembali
            </button>
            <a href="#" id="modalDownloadBtn" class="w-2/3 py-2.5 bg-[var(--sawah-dark)] hover:bg-[var(--sawah)] text-white font-medium text-xs rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all">
                <span class="material-icons-outlined text-sm">download</span> Unduh Master Word
            </a>
        </div>
    </div>
</div>
