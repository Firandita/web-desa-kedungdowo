...
<section class="bg-white py-16">
  <div class="max-w-7xl mx-auto px-5 md:px-8">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <div class="p-5 rounded-xl border border-[var(--sawah)]/15 bg-[var(--krem)] text-center" data-aos="zoom-in" data-aos-delay="0">
      ...
      <div class="p-5 rounded-xl border border-[var(--sawah)]/15 bg-[var(--krem)] text-center" data-aos="zoom-in" data-aos-delay="80">
      ...
      <div class="p-5 rounded-xl border border-[var(--sawah)]/15 bg-[var(--krem)] text-center" data-aos="zoom-in" data-aos-delay="160">
      ...
      <div class="p-5 rounded-xl border border-[var(--sawah)]/15 bg-[var(--krem)] text-center" data-aos="zoom-in" data-aos-delay="240">
...
<section class="bg-white py-16">
  <div class="max-w-7xl mx-auto px-5 md:px-8">
    ...
    <div class="grid sm:grid-cols-3 gap-5 max-w-3xl mx-auto">
      <div class="p-6 rounded-xl bg-[var(--krem)] border border-[var(--sawah)]/15 text-center" data-aos="fade-up" data-aos-delay="0">
        <p class="font-display font-bold text-[var(--sawah-dark)]">Senin – Kamis</p>
        <p class="text-sm text-[var(--tanah)] mt-1">07.30 – 15.30 WIB</p>
      </div>
      <div class="p-6 rounded-xl bg-[var(--krem)] border border-[var(--sawah)]/15 text-center" data-aos="fade-up" data-aos-delay="100">
        <p class="font-display font-bold text-[var(--sawah-dark)]">Jumat</p>
        <p class="text-sm text-[var(--tanah)] mt-1">07.30 – 11.00 WIB</p>
      </div>
      <div class="p-6 rounded-xl bg-[var(--krem)] border border-[var(--sawah)]/15 text-center" data-aos="fade-up" data-aos-delay="200">
