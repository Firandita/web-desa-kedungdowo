<footer id="kontak" class="bg-[var(--sawah-dark)] text-white pt-16 pb-8">
  <div class="max-w-7xl mx-auto px-5 md:px-8 grid md:grid-cols-3 gap-10">
    <div>
      <p class="font-section font-bold text-lg mb-3">Pemerintah Desa Kedungdowo</p>
    ...
    <div>
      <p class="font-section font-semibold mb-3 text-[var(--panen)]">Kontak</p>
      <ul class="text-sm text-white/70 space-y-2">
        <li class="flex items-center gap-2">
          <span class="material-symbols-outlined" style="font-size:18px;">call</span> 0812-xxxx-xxxx
        </li>
        <li class="flex items-center gap-2">
          <span class="material-symbols-outlined" style="font-size:18px;">mail</span> kedungdowo.balen@bojonegorokab.go.id
        </li>
        <li class="flex items-center gap-2">
          <span class="material-symbols-outlined" style="font-size:18px;">schedule</span> Senin–Jumat, 07.30–15.30 WIB
        </li>
      </ul>
    </div>
    <div>
      <p class="font-section font-semibold mb-3 text-[var(--panen)]">Tautan Cepat</p>
      <ul class="text-sm text-white/70 space-y-2">
