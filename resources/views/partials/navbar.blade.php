<header class="sticky top-0 z-50 bg-[var(--krem)]/95 backdrop-blur border-b border-[var(--sawah)]/15">
  <div class="max-w-7xl mx-auto px-5 md:px-8 py-3 flex items-center justify-between">
    <a href="{{ route('beranda') }}" class="flex items-center gap-3">
      ...
      <div>
        <p class="font-display font-bold text-[var(--sawah-dark)] leading-tight">Desa Kedungdowo</p>
    ...
    <button id="menuBtn" class="lg:hidden text-[var(--sawah-dark)] border border-[var(--sawah-dark)]/30 rounded-lg px-3 py-1.5 text-sm">Menu</button>
  </div>
